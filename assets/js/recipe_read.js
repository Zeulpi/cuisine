    ...
    // document.addEventListener('DOMContentLoaded', function () {
        ...
        // if (recipeData) {
            ...
            function createRecipeElement(recipe) {
                ...
                return `
                    <div class="recipe-frame" data-id="${recipe.id}">
                        <div class="recipe-name">${recipe.name}</div>
                        <div class="recipe-image">
                            ${recipe.img ? `<img src="/images/recipes/${recipe.img}" alt="Image">` : `<img src="" alt="Image">`}
                        </div>
                        <div class="recipe-btns" data-update-url="${updateUrl}" data-delete-url="${deleteUrl}">
            ...
            function displayRecipes(page, recipeSubset) {
                ...
                // ✅ Appel du hook d'injection des boutons (si défini)
                if (typeof window.injectRecipeButtons === 'function') {
...
const RecipeList = initRecipeRead();
